...
import { Menu, X, Github, ArrowRight, Brain, Cpu, Car, Zap, ChevronDown, Sparkles } from 'lucide-react';
import './index.css';
...
const Portfolio = () => {
  ...
  return (
    <div className="portfolio">
          ...
          <div className="nav-content">
            <div className="logo">
              ...
              <div className="logo-text-container">
                <div className="logo-text">Agentic AI for Design and Synthesis Lab</div>
            ...
            <div className="nav-links desktop">
              {['home', 'about', 'researchers', 'research', 'publications'].map((item) => (
                <a
                  key={item}
                  href={`#${item}`}
      ...
      <section id="home" className="hero">
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <div className="hero-stats fade-in-up delay-800">
      ...
      {/* Researchers Section */}
      <section id="researchers" className="section researchers-section">
        <div className="container">
          <div className="section-header">
            <h2 className="section-title">Our Research Team</h2>
            <p className="section-subtitle">Meet the brilliant minds behind our innovation</p>
          </div>
            ...
            {researchers.map((researcher, idx) => (
              <div key={idx} className="researcher-card">
                ...
                <div className="researcher-info">
                  ...
                  <div className="researcher-subtitle">{researcher.subtitle}</div>
                  <p className="researcher-description">{researcher.description}</p>
                </div>
              </div>
            ))}
          </div>
